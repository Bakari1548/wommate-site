...
const Formations = () => {
    return (
        <div className='flex flex-col gap-16 my-20'>
            <h1 className="text-3xl text-indigo-900 text-center font-semibold" id="formations" data-aos="zoom-in-down">Formations disponibles</h1>
            <div className='flex flex-row gap-16 justify-center'>
                <div className='flex flex-col gap-3 rounded-t-2xl w-1/5 h-1/5 shadow-slate-400 shadow-inner p-3' data-aos="fade-right">
                ...
                <div className='flex flex-col gap-3 rounded-t-2xl w-1/5 h-1/5 shadow-slate-400 shadow-inner p-3' data-aos="fade-left">
